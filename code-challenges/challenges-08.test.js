...
Done: write a function named sayHello
Todo: the function send the message 'Hello from the back-end'
    Done: setup express (IMPORTANT: DO NOT MODIFY ANY CODE)
...
Done: write a function name oddValues
Done: given Array of integers as input
Todo: use filter to return an array
    Todo: the array should contain only odd integers
    Todo: return an array
------------------------------------------------------------------------------------------------ */

const oddValues = (arr) => {
  // Solution code here...
  return arr.filter(newValue => newValue % 2);
};
...
Done: Write a function named filterStringsWithVowels
Done: given Array of strings as input
Done: use filter to return an array
    Done: the array should contain only vowels
------------------------------------------------------------------------------------------------ */
...
Done: Write a function named notInFirstArray
Done: given is  two arrays as input
Done: uses filter to return an array
    Done: the resulting array should exclude all values from the first array
