...
Todo: Write a function named addTea
Todo: use Jquery to add tea to the list
    Todo: create a new li with 'tea' as a value
Todo: add tea to the shopping list
    Todo: get the element from html
    Todo: append the new li
...
Done: write a function named forLoopTwoToThe
Done: Give it an array of integers as input
Done: iterate over the array
    Done: use a for loop
Done: return a new array
    Done: declare a new empty array
    Done: return the new declared array
Done: the new array values should equal 2 to the power of the old array values 
    Done: give values to the new array using .push
    Done: use Math.pow() with base of 2 and power of old array values.
    Done: access the old array values by the array's index
------------------------------------------------------------------------------------------------ */
...
Done: write a function named forEachTwoToThe
Done: Give it an array of integers as input
...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach(arrayValue =>{
    result.push(Math.pow(2, arrayValue));
  })
  return result;
};
/* ------------------------------------------------------------------------------------------------
...
Done: return a new array
    Done: declare a new empty array
    Done: return the new declared array
Todo: the new array values should equal 2 to the power of the old array values 
    Todo: give values to the new array using .push
    Todo: use Math.pow() with base of 2 and power of old array values.
    Todo: access the old array values by the array's index:: 
------------------------------------------------------------------------------------------------ */

const mapTwoToThe = (arr) => {
  // Solution code here...
  return  arr.map(newValue => Math.pow(2, newValue));
